...
run_test [
		...
		"roots(thePoly)",
		"(-6*a*c/(3*a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)-3*i*3^(1/2)*a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3))-i*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)/(2*3^(1/2)*a)-b/(3*a)+(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)/(6*a)+2*b^2/(3*a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)-3*i*3^(1/2)*a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)),-6*a*c/(3*a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)+3*i*3^(1/2)*a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3))+i*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)/(2*3^(1/2)*a)-b/(3*a)+(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)/(6*a)+2*b^2/(3*a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)+3*i*3^(1/2)*a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)),c/((-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3))-b/(3*a)-b^2/(3*a*(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3))-(-9/2*a*b*c+b^3+1/2*(-27*a^2*b^2*c^2+108*a^2*b^3*d-486*a^3*b*c*d+108*a^3*c^3+729*a^4*d^2)^(1/2)+27/2*a^2*d)^(1/3)/(3*a))",
		...
		"roots(thePoly)",
		"(-3/((27/2+27/2*i*3^(1/2))^(1/3))-1/3*(27/2+27/2*i*3^(1/2))^(1/3),1/6*(27/2+27/2*i*3^(1/2))^(1/3)+18/(3*(27/2+27/2*i*3^(1/2))^(1/3)-3*i*3^(1/2)*(27/2+27/2*i*3^(1/2))^(1/3))-i*(27/2+27/2*i*3^(1/2))^(1/3)/(2*3^(1/2)),1/6*(27/2+27/2*i*3^(1/2))^(1/3)+18/(3*(27/2+27/2*i*3^(1/2))^(1/3)+3*i*3^(1/2)*(27/2+27/2*i*3^(1/2))^(1/3))+i*(27/2+27/2*i*3^(1/2))^(1/3)/(2*3^(1/2)))",
		...
		"roots(thePoly)",
		"(10/9-226/(9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3))-1/9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3),10/9+1/18*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3)+452/(9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3)-9*i*3^(1/2)*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3))-i*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3)/(6*3^(1/2)),10/9+1/18*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3)+452/(9*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3)+9*i*3^(1/2)*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3))+i*(781/2+9/2*i*3^(1/2)*97^(1/2)*1933^(1/2))^(1/3)/(6*3^(1/2)))",
		...
		"roots(thePoly)",
		"(-2-2*2^(1/3)-2*2^(2/3),-2+2^(2/3)+144/(18*2^(2/3)-18*i*2^(2/3)*3^(1/2))-i*2^(2/3)*3^(1/2),-2+2^(2/3)+144/(18*2^(2/3)+18*i*2^(2/3)*3^(1/2))+i*2^(2/3)*3^(1/2))",
		...
		"roots(thePoly)",
		"(1/6*(-135+27*89^(1/2))^(1/3)-72/(3*(-135+27*89^(1/2))^(1/3)-3*i*3^(1/2)*(-135+27*89^(1/2))^(1/3))-i*(-135+27*89^(1/2))^(1/3)/(2*3^(1/2)),1/6*(-135+27*89^(1/2))^(1/3)-72/(3*(-135+27*89^(1/2))^(1/3)+3*i*3^(1/2)*(-135+27*89^(1/2))^(1/3))+i*(-135+27*89^(1/2))^(1/3)/(2*3^(1/2)),12/((-135+27*89^(1/2))^(1/3))-1/3*(-135+27*89^(1/2))^(1/3))",
		...
		"roots(thePoly)",
		"(-3/((-81+54*2^(1/2))^(1/3))-1/3*(-81+54*2^(1/2))^(1/3),1/6*(-81+54*2^(1/2))^(1/3)+18/(3*(-81+54*2^(1/2))^(1/3)-3*i*3^(1/2)*(-81+54*2^(1/2))^(1/3))-i*(-81+54*2^(1/2))^(1/3)/(2*3^(1/2)),1/6*(-81+54*2^(1/2))^(1/3)+18/(3*(-81+54*2^(1/2))^(1/3)+3*i*3^(1/2)*(-81+54*2^(1/2))^(1/3))+i*(-81+54*2^(1/2))^(1/3)/(2*3^(1/2)))",
		...
		"roots(thePoly)",
		"(-7/3-47/((18117/2+27/2*34949^(1/2))^(1/3))-1/9*(18117/2+27/2*34949^(1/2))^(1/3),-7/3+1/18*(18117/2+27/2*34949^(1/2))^(1/3)+846/(9*(18117/2+27/2*34949^(1/2))^(1/3)-9*i*3^(1/2)*(18117/2+27/2*34949^(1/2))^(1/3))-i*(18117/2+27/2*34949^(1/2))^(1/3)/(6*3^(1/2)),-7/3+1/18*(18117/2+27/2*34949^(1/2))^(1/3)+846/(9*(18117/2+27/2*34949^(1/2))^(1/3)+9*i*3^(1/2)*(18117/2+27/2*34949^(1/2))^(1/3))+i*(18117/2+27/2*34949^(1/2))^(1/3)/(6*3^(1/2)))",
